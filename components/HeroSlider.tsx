...
export default function HeroSlider({ banners }: { banners: Banner[] }) {
  ...
  if (banners.length === 0) {
    return (
      <div className="relative aspect-[21/9] sm:aspect-[3/1] rounded-2xl overflow-hidden bg-cream">
  ...
  return (
    <div className="relative">
      <div className="overflow-hidden rounded-2xl" ref={emblaRef}>
        <div className="flex">
          {banners.map((b) => (
            <div key={b.id} className="relative min-w-0 flex-[0_0_100%] aspect-[21/9] sm:aspect-[3/1] bg-cream">
              {b.link_url ? (
